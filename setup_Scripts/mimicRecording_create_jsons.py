...
# Utility script to create the training and test json files from mimic-recording-studio (own voice).
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="cript to create the training and test json files for mimic-recording-studio (own voice)")
